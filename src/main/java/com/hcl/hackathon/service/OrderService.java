...
import com.hcl.hackathon.exception.ResourceAlreadyExistsException;
...
public class OrderService {
    ...
    public Contact findById(Long id) throws ResourceNotFoundException {
        ...
        if (contact==null) {
            throw new ResourceNotFoundException(HttpStatus.NOT_FOUND.value(),"Cannot find Contact with id: " + id);
        }
        else return contact;
    }
    ...
    public Contact save(Contact contact) throws BadResourceException, ResourceAlreadyExistsException {
        if (!StringUtils.isEmpty(contact.getName())) {
            if (contact.getId() != null && existsById(contact.getId())) { 
                throw new ResourceAlreadyExistsException(HttpStatus.NOT_FOUND.value(),"Contact with id: " + contact.getId() +
                        " already exists");
            }
    ...
    public void update(Contact contact) 
        ...
        if (!StringUtils.isEmpty(contact.getName())) {
            if (!existsById(contact.getId())) {
                throw new ResourceNotFoundException(HttpStatus.NOT_FOUND.value(),"Cannot find Contact with id: " + contact.getId());
            }
